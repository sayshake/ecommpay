# Тестовое задание
сборка gulp-scss-starter (ссылки и документацию оставил как в оргинальной сборке)
посмотреть загруженную на сервер работу : https://sayshake.github.io/ecommpay/
